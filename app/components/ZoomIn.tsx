...
const ZoomIn = () => {
  ...
  return (
    <div className="mt-40 lg:pt-24 flex flex-col items-center overflow-hidden">
        ...
        <p className="text-[#969696] text-base lg:text-[1.375rem] lg:leading-[1.75rem] text-center w-4/5 lg:w-full mx-6 lg:mx-0  lg:px-8 xl:px-0" >Endure the wear and tear of typical fading and sun damage. Build it brighter. Build it to last.</p>
        <div className="flex flex-col items-center max-w-[1300px] mt-12 lg:px-8 xl:px-0"  ref={brickSectionRef}>

        <Image src="/images/yellow-brick.png" alt="brick-img" width={1300} height={356} className="mt-0 mx-auto hidden lg:block lg:w-full xl:w-[90%] 2xl:w-[1300px] scale-[2] h-auto max-w-none" ref={brickRef} onLoad={handleImageLoad} style={{ transformOrigin: 'top center'}} />
        </div>
