...
const ZoomIn: React.FC<ZoomInProps> = ({ font }) => {
  ...
  return (
    <div className="mt-40 lg:mt-56 flex flex-col items-center" ref={brickSectionRef}>
        ...
        <Image src="/images/gray-brick.png" alt="brick-img" width={1300} height={356} className="mt-12 hidden lg:block w-4/5" ref={brickRef} />


        <div className="mt-28 pt-28 lg:pt-0 flex flex-col lg:flex-row justify-between items-center lg:items-start w-full lg:w-[77%] bg-black lg:bg-transparent">
