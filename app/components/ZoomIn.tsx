...
const ZoomIn: React.FC<ZoomInProps> = ({ font }) => {
  ...
  return (
    <div className="mt-40 lg:mt-56 flex flex-col items-center" ref={brickSectionRef}>
        <Image src="/images/gray-brick.png" alt="brick-img" width={1300} height={356} className="mt-12 mb-20 lg:hidden scale-[2.5]" ref={brickRef} />
        ...
        <p className="text-[#969696] text-base text-center w-4/5 lg:w-full" ref={textBottomRef}>Endure the wear and tear of typical fading and sun damage. Build it brighter. Build it to last.</p>
        <Image src="/images/gray-brick.png" alt="brick-img" width={1300} height={356} className="mt-12 hidden lg:block" ref={brickRef} />


        <div className="mt-28 pt-28 lg:pt-0 flex flex-col lg:flex-row justify-between items-center lg:items-start max-w-[1270px] bg-black lg:bg-transparent">
          <h2 className={`${font.className} antialiased text-[#F3F3F6] font-bold text-[3rem] lg:text-[5.25rem] leading-[3rem] lg:leading-[5.3rem] uppercase fade-up-zoom`}>Custom<br /> Created</h2>
          <p className="text-[#969696] text-base lg:text-[22px] w-4/5 lg:w-1/2 text-center lg:text-left fade-up-zoom">Unlike mass produced clay bricks, every batch of the Bilco Professional Line is <span className="text-[#f3f3f6]">made to order.</span> <br/><br/>Through this personalized manufacturing process, the bricks are guaranteed to reflect your vision.</p>
